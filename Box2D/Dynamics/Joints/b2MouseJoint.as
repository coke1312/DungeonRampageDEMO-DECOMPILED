package Box2D.Dynamics.Joints
{
   ...
   public class b2MouseJoint extends b2Joint
   {
      ...
      public function b2MouseJoint(param1:b2MouseJointDef)
      {
         ...
         var _loc3_:Number = this.m_target.y - b2internal::m_bodyB.b2internal::m_xf.position.y;
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc8_:Number = this.m_localAnchor.x - _loc2_.b2internal::m_sweep.localCenter.x;
         var _loc9_:Number = this.m_localAnchor.y - _loc2_.b2internal::m_sweep.localCenter.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc6_:Number = this.m_localAnchor.x - _loc2_.b2internal::m_sweep.localCenter.x;
         var _loc7_:Number = this.m_localAnchor.y - _loc2_.b2internal::m_sweep.localCenter.y;
         _loc4_ = _loc3_.col1.x * _loc6_ + _loc3_.col2.x * _loc7_;
         _loc7_ = _loc3_.col1.y * _loc6_ + _loc3_.col2.y * _loc7_;
         _loc6_ = _loc4_;
         var _loc8_:Number = _loc2_.b2internal::m_linearVelocity.x + -_loc2_.b2internal::m_angularVelocity * _loc7_;
         var _loc9_:Number = _loc2_.b2internal::m_linearVelocity.y + _loc2_.b2internal::m_angularVelocity * _loc6_;
         _loc3_ = this.m_mass;
