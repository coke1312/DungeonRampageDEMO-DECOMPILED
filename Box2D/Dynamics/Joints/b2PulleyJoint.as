package Box2D.Dynamics.Joints
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      {
         var _loc1_:b2Vec2 = this.m_ground.b2internal::m_xf.position.Copy();
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc2_:Number = this.m_ground.b2internal::m_xf.position.x + this.m_groundAnchor1.x;
         var _loc3_:Number = this.m_ground.b2internal::m_xf.position.y + this.m_groundAnchor1.y;
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc2_:Number = this.m_ground.b2internal::m_xf.position.x + this.m_groundAnchor2.x;
         var _loc3_:Number = this.m_ground.b2internal::m_xf.position.y + this.m_groundAnchor2.y;
         var _loc4_:Number = _loc1_.x - _loc2_;
         var _loc5_:Number = _loc1_.y - _loc3_;
         return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
      }
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc5_:Number = this.m_localAnchor1.x - _loc2_.b2internal::m_sweep.localCenter.x;
         ...
         var _loc8_:Number = this.m_localAnchor2.x - _loc3_.b2internal::m_sweep.localCenter.x;
         var _loc9_:Number = this.m_localAnchor2.y - _loc3_.b2internal::m_sweep.localCenter.y;
         _loc7_ = _loc4_.col1.x * _loc8_ + _loc4_.col2.x * _loc9_;
         _loc9_ = _loc4_.col1.y * _loc8_ + _loc4_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         var _loc10_:Number = _loc2_.b2internal::m_sweep.c.x + _loc5_;
         var _loc11_:Number = _loc2_.b2internal::m_sweep.c.y + _loc6_;
         var _loc12_:Number = _loc3_.b2internal::m_sweep.c.x + _loc8_;
         var _loc13_:Number = _loc3_.b2internal::m_sweep.c.y + _loc9_;
         var _loc14_:Number = this.m_ground.b2internal::m_xf.position.x + this.m_groundAnchor1.x;
         var _loc15_:Number = this.m_ground.b2internal::m_xf.position.y + this.m_groundAnchor1.y;
         var _loc16_:Number = this.m_ground.b2internal::m_xf.position.x + this.m_groundAnchor2.x;
         var _loc17_:Number = this.m_ground.b2internal::m_xf.position.y + this.m_groundAnchor2.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         _loc4_ = _loc2_.b2internal::m_xf.R;
         var _loc5_:Number = this.m_localAnchor1.x - _loc2_.b2internal::m_sweep.localCenter.x;
         var _loc6_:Number = this.m_localAnchor1.y - _loc2_.b2internal::m_sweep.localCenter.y;
         var _loc7_:Number = _loc4_.col1.x * _loc5_ + _loc4_.col2.x * _loc6_;
         _loc6_ = _loc4_.col1.y * _loc5_ + _loc4_.col2.y * _loc6_;
         _loc5_ = _loc7_;
         _loc4_ = _loc3_.b2internal::m_xf.R;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         var _loc2_:b2Body = b2internal::m_bodyA;
         var _loc3_:b2Body = b2internal::m_bodyB;
         var _loc5_:Number = this.m_ground.b2internal::m_xf.position.x + this.m_groundAnchor1.x;
         var _loc6_:Number = this.m_ground.b2internal::m_xf.position.y + this.m_groundAnchor1.y;
         var _loc7_:Number = this.m_ground.b2internal::m_xf.position.x + this.m_groundAnchor2.x;
         var _loc8_:Number = this.m_ground.b2internal::m_xf.position.y + this.m_groundAnchor2.y;
