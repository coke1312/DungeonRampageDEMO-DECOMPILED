package Box2D.Dynamics.Joints
{
   ...
   public class b2DistanceJoint extends b2Joint
   {
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc6_:Number = this.m_localAnchor1.x - _loc4_.b2internal::m_sweep.localCenter.x;
         _loc7_ = this.m_localAnchor1.y - _loc4_.b2internal::m_sweep.localCenter.y;
         _loc3_ = _loc2_.col1.x * _loc6_ + _loc2_.col2.x * _loc7_;
         _loc7_ = _loc2_.col1.y * _loc6_ + _loc2_.col2.y * _loc7_;
         _loc6_ = _loc3_;
         _loc2_ = _loc5_.b2internal::m_xf.R;
         var _loc8_:Number = this.m_localAnchor2.x - _loc5_.b2internal::m_sweep.localCenter.x;
         ...
         var _loc13_:Number = _loc4_.b2internal::m_invMass + _loc4_.b2internal::m_invI * _loc11_ * _loc11_ + _loc5_.b2internal::m_invMass + _loc5_.b2internal::m_invI * _loc12_ * _loc12_;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc5_:Number = this.m_localAnchor1.x - _loc3_.b2internal::m_sweep.localCenter.x;
         var _loc6_:Number = this.m_localAnchor1.y - _loc3_.b2internal::m_sweep.localCenter.y;
         var _loc7_:Number = _loc2_.col1.x * _loc5_ + _loc2_.col2.x * _loc6_;
         _loc6_ = _loc2_.col1.y * _loc5_ + _loc2_.col2.y * _loc6_;
         _loc5_ = _loc7_;
         _loc2_ = _loc4_.b2internal::m_xf.R;
         var _loc8_:Number = this.m_localAnchor2.x - _loc4_.b2internal::m_sweep.localCenter.x;
         var _loc9_:Number = this.m_localAnchor2.y - _loc4_.b2internal::m_sweep.localCenter.y;
         _loc7_ = _loc2_.col1.x * _loc8_ + _loc2_.col2.x * _loc9_;
         _loc9_ = _loc2_.col1.y * _loc8_ + _loc2_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         var _loc10_:Number = _loc3_.b2internal::m_linearVelocity.x + -_loc3_.b2internal::m_angularVelocity * _loc6_;
         var _loc11_:Number = _loc3_.b2internal::m_linearVelocity.y + _loc3_.b2internal::m_angularVelocity * _loc5_;
         var _loc12_:Number = _loc4_.b2internal::m_linearVelocity.x + -_loc4_.b2internal::m_angularVelocity * _loc9_;
         var _loc13_:Number = _loc4_.b2internal::m_linearVelocity.y + _loc4_.b2internal::m_angularVelocity * _loc8_;
      ...
      override b2internal function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         _loc9_ = _loc2_.col1.y * _loc8_ + _loc2_.col2.y * _loc9_;
         _loc8_ = _loc7_;
         var _loc10_:Number = _loc4_.b2internal::m_sweep.c.x + _loc8_ - _loc3_.b2internal::m_sweep.c.x - _loc5_;
         var _loc11_:Number = _loc4_.b2internal::m_sweep.c.y + _loc9_ - _loc3_.b2internal::m_sweep.c.y - _loc6_;
