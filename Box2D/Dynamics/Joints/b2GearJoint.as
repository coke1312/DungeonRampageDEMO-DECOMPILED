package Box2D.Dynamics.Joints
{
   ...
   public class b2GearJoint extends b2Joint
   {
      ...
      public function b2GearJoint(param1:b2GearJointDef)
      {
         ...
         super(param1);
         var _loc2_:int = param1.joint1.b2internal::m_type;
         var _loc3_:int = param1.joint2.b2internal::m_type;
      ...
      {
         var _loc2_:b2Mat22 = b2internal::m_bodyB.b2internal::m_xf.R;
         var _loc3_:Number = this.m_localAnchor1.x - b2internal::m_bodyB.b2internal::m_sweep.localCenter.x;
         var _loc4_:Number = this.m_localAnchor1.y - b2internal::m_bodyB.b2internal::m_sweep.localCenter.y;
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc4_:Number = this.m_J.Compute(_loc2_.b2internal::m_linearVelocity,_loc2_.b2internal::m_angularVelocity,_loc3_.b2internal::m_linearVelocity,_loc3_.b2internal::m_angularVelocity);
