      ...
      public function Initialize(param1:b2TimeStep, param2:Vector.<b2Contact>, param3:int, param4:*) : void
      {
         ...
         while(_loc6_ < param3)
         {
            ...
            while(_loc29_ < _loc28_.pointCount)
            {
               ...
               _loc32_ = _loc31_.rA.x = s_worldManifold.m_points[_loc29_].x - _loc15_.b2internal::m_sweep.c.x;
               _loc33_ = _loc31_.rA.y = s_worldManifold.m_points[_loc29_].y - _loc15_.b2internal::m_sweep.c.y;
               _loc34_ = _loc31_.rB.x = s_worldManifold.m_points[_loc29_].x - _loc16_.b2internal::m_sweep.c.x;
               _loc35_ = _loc31_.rB.y = s_worldManifold.m_points[_loc29_].y - _loc16_.b2internal::m_sweep.c.y;
