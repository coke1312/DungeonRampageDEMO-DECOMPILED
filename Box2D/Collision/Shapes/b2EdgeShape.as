package Box2D.Collision.Shapes
{
   ...
   public class b2EdgeShape extends b2Shape
   {
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         _loc4_ = param3.R;
         var _loc7_:Number = param3.position.x + (_loc4_.col1.x * this.b2internal::m_v1.x + _loc4_.col2.x * this.b2internal::m_v1.y);
         var _loc8_:Number = param3.position.y + (_loc4_.col1.y * this.b2internal::m_v1.x + _loc4_.col2.y * this.b2internal::m_v1.y);
         var _loc9_:Number = param3.position.y + (_loc4_.col1.y * this.b2internal::m_v2.x + _loc4_.col2.y * this.b2internal::m_v2.y) - _loc8_;
         var _loc10_:Number = -(param3.position.x + (_loc4_.col1.x * this.b2internal::m_v2.x + _loc4_.col2.x * this.b2internal::m_v2.y) - _loc7_);
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc6_:b2Vec2 = b2Math.MulX(param3,this.b2internal::m_v1);
         var _loc7_:b2Vec2 = b2Math.MulX(param3,this.b2internal::m_v2);
      ...
      public function Support(param1:b2Transform, param2:Number, param3:Number) : b2Vec2
      {
         ...
         var _loc5_:Number = param1.position.x + (_loc4_.col1.x * this.b2internal::m_coreV1.x + _loc4_.col2.x * this.b2internal::m_coreV1.y);
         var _loc6_:Number = param1.position.y + (_loc4_.col1.y * this.b2internal::m_coreV1.x + _loc4_.col2.y * this.b2internal::m_coreV1.y);
         var _loc7_:Number = param1.position.x + (_loc4_.col1.x * this.b2internal::m_coreV2.x + _loc4_.col2.x * this.b2internal::m_coreV2.y);
         var _loc8_:Number = param1.position.y + (_loc4_.col1.y * this.b2internal::m_coreV2.x + _loc4_.col2.y * this.b2internal::m_coreV2.y);
