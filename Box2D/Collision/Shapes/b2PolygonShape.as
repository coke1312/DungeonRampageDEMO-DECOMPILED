package Box2D.Collision.Shapes
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public function SetAsVector(param1:Vector.<b2Vec2>, param2:Number = 0) : void
      {
         ...
         this.b2internal::m_vertexCount = param2;
         this.Reserve(param2);
         _loc3_ = 0;
         while(_loc3_ < this.b2internal::m_vertexCount)
         {
         ...
         this.b2internal::m_centroid = ComputeCentroid(this.b2internal::m_vertices,this.b2internal::m_vertexCount);
      }
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:b2Vec2 = this.b2internal::m_vertices[0];
      ...
      override public function ComputeMass(param1:b2MassData, param2:Number) : void
      {
         ...
         while(_loc10_ < this.b2internal::m_vertexCount)
         {
            ...
            _loc12_ = _loc10_ + 1 < this.b2internal::m_vertexCount ? this.b2internal::m_vertices[int(_loc10_ + 1)] : this.b2internal::m_vertices[0];
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc13_:int = (_loc9_ + 1) % this.b2internal::m_vertexCount;
         var _loc14_:int = (_loc10_ + 1) % this.b2internal::m_vertexCount;
         ...
         var _loc17_:b2Vec2 = new b2Vec2(this.b2internal::m_vertices[_loc9_].x * (1 - _loc15_) + this.b2internal::m_vertices[_loc13_].x * _loc15_,this.b2internal::m_vertices[_loc9_].y * (1 - _loc15_) + this.b2internal::m_vertices[_loc13_].y * _loc15_);
         var _loc18_:b2Vec2 = new b2Vec2(this.b2internal::m_vertices[_loc10_].x * (1 - _loc16_) + this.b2internal::m_vertices[_loc14_].x * _loc16_,this.b2internal::m_vertices[_loc10_].y * (1 - _loc16_) + this.b2internal::m_vertices[_loc14_].y * _loc16_);
         var _loc19_:Number = 0;
         var _loc20_:b2Vec2 = new b2Vec2();
         var _loc21_:b2Vec2 = this.b2internal::m_vertices[_loc13_];
         _loc12_ = _loc13_;
      ...
      public function GetSupport(param1:b2Vec2) : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:Number = this.b2internal::m_vertices[0].x * param1.x + this.b2internal::m_vertices[0].y * param1.y;
         var _loc4_:int = 1;
      ...
      {
         var _loc2_:int = int(this.b2internal::m_vertices.length);
         while(_loc2_ < param1)
         {
