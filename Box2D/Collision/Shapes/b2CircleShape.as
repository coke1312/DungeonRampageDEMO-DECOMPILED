package Box2D.Collision.Shapes
{
   ...
   public class b2CircleShape extends b2Shape
   {
      ...
      override public function TestPoint(param1:b2Transform, param2:b2Vec2) : Boolean
      {
         ...
         var _loc4_:Number = param1.position.x + (_loc3_.col1.x * this.b2internal::m_p.x + _loc3_.col2.x * this.b2internal::m_p.y);
         var _loc5_:Number = param1.position.y + (_loc3_.col1.y * this.b2internal::m_p.x + _loc3_.col2.y * this.b2internal::m_p.y);
      ...
      override public function RayCast(param1:b2RayCastOutput, param2:b2RayCastInput, param3:b2Transform) : Boolean
      {
         ...
         var _loc5_:Number = param3.position.x + (_loc4_.col1.x * this.b2internal::m_p.x + _loc4_.col2.x * this.b2internal::m_p.y);
         var _loc6_:Number = param3.position.y + (_loc4_.col1.y * this.b2internal::m_p.x + _loc4_.col2.y * this.b2internal::m_p.y);
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         var _loc4_:Number = param2.position.x + (_loc3_.col1.x * this.b2internal::m_p.x + _loc3_.col2.x * this.b2internal::m_p.y);
         var _loc5_:Number = param2.position.y + (_loc3_.col1.y * this.b2internal::m_p.x + _loc3_.col2.y * this.b2internal::m_p.y);
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         var _loc5_:b2Vec2 = b2Math.MulX(param3,this.b2internal::m_p);
         var _loc6_:Number = -(b2Math.Dot(param1,_loc5_) - param2);
         if(_loc6_ < -b2internal::m_radius + Number.MIN_VALUE)
         {
            return 0;
         }
