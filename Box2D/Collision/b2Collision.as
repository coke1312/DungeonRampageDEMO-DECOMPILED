package Box2D.Collision
{
   ...
   public class b2Collision
   {
      ...
      public static function EdgeSeparation(param1:b2PolygonShape, param2:b2Transform, param3:int, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc6_:int = param1.b2internal::m_vertexCount;
         var _loc7_:Vector.<b2Vec2> = param1.b2internal::m_vertices;
         var _loc8_:Vector.<b2Vec2> = param1.b2internal::m_normals;
         var _loc9_:int = param4.b2internal::m_vertexCount;
         var _loc10_:Vector.<b2Vec2> = param4.b2internal::m_vertices;
         _loc11_ = param2.R;
      ...
      public static function FindMaxSeparation(param1:Vector.<int>, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : Number
      {
         ...
         var _loc24_:int = 0;
         var _loc25_:Number = NaN;
         var _loc6_:int = param2.b2internal::m_vertexCount;
         var _loc7_:Vector.<b2Vec2> = param2.b2internal::m_normals;
         _loc9_ = param5.R;
      ...
      public static function FindIncidentEdge(param1:Vector.<ClipVertex>, param2:b2PolygonShape, param3:b2Transform, param4:int, param5:b2PolygonShape, param6:b2Transform) : void
      {
         ...
         var _loc23_:Number = NaN;
         var _loc7_:int = param2.b2internal::m_vertexCount;
         var _loc8_:Vector.<b2Vec2> = param2.b2internal::m_normals;
         var _loc9_:int = param5.b2internal::m_vertexCount;
         var _loc10_:Vector.<b2Vec2> = param5.b2internal::m_vertices;
         var _loc11_:Vector.<b2Vec2> = param5.b2internal::m_normals;
         _loc12_ = param3.R;
      ...
      public static function CollidePolygons(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2PolygonShape, param5:b2Transform) : void
      {
         ...
         var _loc7_:Number = param2.b2internal::m_radius + param4.b2internal::m_radius;
         var _loc8_:int = 0;
         s_edgeAO[0] = _loc8_;
         ...
         var _loc22_:int = _loc12_.b2internal::m_vertexCount;
         var _loc23_:Vector.<b2Vec2> = _loc12_.b2internal::m_vertices;
      ...
      public static function CollideCircles(param1:b2Manifold, param2:b2CircleShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc15_:Number = param2.b2internal::m_radius + param4.b2internal::m_radius;
      ...
      public static function CollidePolygonAndCircle(param1:b2Manifold, param2:b2PolygonShape, param3:b2Transform, param4:b2CircleShape, param5:b2Transform) : void
      {
         ...
         var _loc20_:Number = param2.b2internal::m_radius + param4.b2internal::m_radius;
         var _loc21_:int = param2.b2internal::m_vertexCount;
         var _loc22_:Vector.<b2Vec2> = param2.b2internal::m_vertices;
         var _loc23_:Vector.<b2Vec2> = param2.b2internal::m_normals;
         var _loc24_:int = 0;
